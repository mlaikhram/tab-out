    ...
    return (
        <ListGroupItem style={{ paddingLeft: '0%' }}>
            <Row>
                ...
                <Col sm={7} style={{ paddingRight: '1%' }}><Input value={props.payer.name} onChange={props.onPayerNameChange} id={"payerId" + props.payer.id} /></Col>
                ...
                <Col sm={2} style={{ paddingLeft: '2%' }} ><PayerIcon payer={props.payer} /></Col>
            </Row>
        </ListGroupItem>
    );
}
