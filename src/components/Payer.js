        ...
        <ListGroupItem style={{ paddingLeft: '0%' }}>
            <div>
                <Row>
                    ...
                    <Col sm={6} style={{ paddingRight: '1%', width: '57%' }}><Input placeholder='Name' value={props.payer.name} onChange={props.onPayerNameChange} id={"payerId" + props.payer.id} /></Col>
                    <Col sm={1} style={{ paddingLeft: '1%', paddingTop: '2%', paddingRight: '0%' }}><Input type="color" value={props.payer.color} onChange={props.onColorChange} style={{ padding: '0%', cursor: 'pointer' }} /></Col>
